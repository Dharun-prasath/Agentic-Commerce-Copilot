...
Revision ID: 6af923d6bbf7
Revises: 99eff4e3650f
Create Date: 2026-08-29 23:33:56.462648
...
revision: str = '6af923d6bbf7'
down_revision: Union[str, None] = '99eff4e3650f'
...
def upgrade() -> None:
    ...
    sa.Column('context_memory_size', sa.Integer(), nullable=False),
    sa.Column('fallback_behavior', sa.String(), nullable=False),
    sa.Column('output_formatting', sa.String(), nullable=False),
    sa.Column('processing_timeout_ms', sa.Integer(), nullable=False),
